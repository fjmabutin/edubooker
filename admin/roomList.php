...
<div class="main-content">
    ...
    <div class="room-card">
        ...
        <div class="room-left">
            <img src="../assets/comlab.jpg" class="room-img">
            <div class="room-info">
                <h3>COMLAB 202</h3>
                <p>50 Capacity</p>
            </div>
    ...
    <div class="room-card">
        ...
        <div class="room-left">
            <img src="../assets/comlab2.jpg" class="room-img">
            <div class="room-info">
                <h3>COMLAB 201</h3>
                <p>50 Capacity</p>
    ...
    <div class="room-card">
        ...
        <div class="room-left">
            <img src="../assets/comlab3.jpg" class="room-img">
            <div class="room-info">
                <h3>COMLAB 101</h3>
                <p>60 Capacity</p>
    ...
    <div class="room-card">
        ...
        <div class="room-left">
            <img src="../assets/comlab4.jpg" class="room-img">
            <div class="room-info">
                <h3>COMLAB 302</h3>
                <p>20 Capacity</p>
